    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an in expert resume writing. Your task is to enhance the professional summary of a resume. " +
            ...
            messages: [
                {
                    ...
                    content: "You are an expert in resume writing. Your task is to enhance the job description of a resume. " +
                        "The job description should be 1-2 sentences also highlighting responsibilities and achievements. Use action verbs and quantifiable results where possible." +
                        "Make it compelling and ATS-friendly, and only return text no option or anything else."
                },
...
// post: /api/ai/upload-resume - AI Upload Resume and extract key information
